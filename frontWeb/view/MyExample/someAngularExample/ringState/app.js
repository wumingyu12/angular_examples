...
MyApp.directive('ringstate',function(){ 
	return{
		...
		template:
			//为了半圆裁剪，加position:relative,底圆，这里的颜色将会显示剩下的percent比
			'<div style="height: 100%;width:100%;background-color:rgb(283,23,0);border-radius:50%;;position:relative;">'+  
				//用来遮挡旋转进入左边的半圆部分
				'<div style="height:100%;width:100%;position:absolute;clip:rect(0px,200px,200px,100px);">'+
					//可旋转的右半圆,这里的颜色将会是显示percent值
					'<div id="rightcir" style="height: 100%;width:100%;background-color:rgb(28,23,111);'+
								'border-radius:50%;'+
				...
				'<div style="height:100%;width:100%;position:absolute;clip:rect(0px,100px,200px,0px);">'+
					//可旋转的左半圆
					'<div id="leftcir" style="height: 100%;width:100%;background-color:rgb(28,23,111);'+
								'border-radius:50%;'+
				...
				'<div style="height:80%;width:80%;background-color:rgb(280,230,111);'+
